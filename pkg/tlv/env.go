...
const (
	...
	// Тип сообщения на отправку закрытие соединения (инициатор)
	// Идет с BRT
	TYPE_SHUTDOWN_REQ uint16 = 0x0005
	// Тип сообщения на отправку  закрытие соединения (подтверждение)
	// Идет с SCP -> BRT ответ
	TYPE_SHUTDOWN_RESP uint16 = 0x0006
