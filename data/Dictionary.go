...
func init() {
	var dictionaries = []struct{ name, xml string }{
		...
		//	{"TGPP_S6a", tgpps6aXML},
		//	{"TGPP_Swx", tgppswxXML},
		//	{"3GPP_cust", gppcustXML},
	}
	var err error
	Default, err = dict.NewParser()
	if err != nil {
		panic(err)
	}
...
var gppcustXML = `<?xml version="1.0" encoding="UTF-8"?>
<diameter>
	<application>
        <avp name="MBMS-BMSC-SSM-IP-Address" code="918" must="M,V" may-encrypt="N" vendor-id="11971">
            <!-- 3GGPP TS 29.230-->
            <data type="UTF8String"/>
        </avp>
		<avp name="MBMS-StartStop-Indication" code="902" must="M,V" may-encrypt="N" vendor-id="11971">
            <!-- 3GGPP TS 29.230-->
            <data type="Enumerated"/>
        </avp>
...
var baseXML_easy = `<?xml version="1.0" encoding="UTF-8"?>
<diameter>
